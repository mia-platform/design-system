...
import { SegmentedControlHierarchy, SegmentedControlOptionAlignment } from './SegmentedControl.types'
...
export const Primary: Story = {
  args: { ...meta.args, hierarchy: SegmentedControlHierarchy.Primary },
}

export const Vertical: Story = {
  args: { ...meta.args, optionsAlignment: SegmentedControlOptionAlignment.Vertical },
}
